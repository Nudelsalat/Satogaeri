...
\begin{scope}
	...
	\draw[very thick] (1, 4)--(5, 4);
	\draw[very thick] (0, 3)--(2, 3);
	\draw[very thick] (3, 2)--(5, 2);
	\draw[very thick] (0, 1)--(4, 1);
	
	\draw[very thick] (1, 4)--(1, 3);
	\draw[very thick] (2, 3)--(2, 0);
	\draw[very thick] (3, 5)--(3, 2);
	\draw[very thick] (4, 2)--(4, 1);
	
	\node[anchor=center] at (0.5, 4.5) {2};
	\draw (0.5, 4.5) circle [radius=0.4];
	\node[anchor=center] at (3.5, 3.5) {1};
	\draw (3.5, 3.5) circle [radius=0.4];
	
	\draw (1.5, 2.5) circle [radius=0.4];
	\node[anchor=center] at (2.5, 2.5) {2};
	\draw (2.5, 2.5) circle [radius=0.4];
	\node[anchor=center] at (3.5, 2.5) {1};
	\draw (3.5, 2.5) circle [radius=0.4];
	\node[anchor=center] at (0.5, 1.5) {1};
	\draw (0.5, 1.5) circle [radius=0.4];
	\node[anchor=center] at (1.5, 1.5) {1};
	\draw (1.5, 1.5) circle [radius=0.4];
...
\draw[gray] (0, 0) grid (5, 5);
	...
	\node[anchor=center] at (2.5, 4.5) {2};
	\draw (2.5, 4.5) circle [radius=0.4];
	\node[anchor=center] at (3.5, 4.5) {1};
	\draw (3.5, 4.5) circle [radius=0.4];
	
	\draw (1.5, 3.5) circle [radius=0.4];
	\node[anchor=center] at (2.5, 0.5) {2};
	\draw (2.5, 0.5) circle [radius=0.4];
	\node[anchor=center] at (4.5, 2.5) {1};
	\draw (4.5, 2.5) circle [radius=0.4];
	\node[anchor=center] at (0.5, 2.5) {1};
	\draw (0.5, 2.5) circle [radius=0.4];
	\node[anchor=center] at (1.5, 0.5) {1};
	\draw (1.5, 0.5) circle [radius=0.4];
	
	\draw[very thick,arrows={|->[scale=1.5]}] (0.5, 4.5) -- (2.1, 4.5);
	\draw[very thick,arrows={|->[scale=1.5]}] (3.5, 3.5) -- (3.5, 4.1);
	\draw[very thick,arrows={|->[scale=1.5]}] (1.5, 2.5) -- (1.5, 3.1);
	\draw[very thick,arrows={|->[scale=1.5]}] (2.5, 2.5) -- (2.5, 0.9);
	\draw[very thick,arrows={|->[scale=1.5]}] (3.5, 2.5) -- (4.1, 2.5);
	\draw[very thick,arrows={|->[scale=1.5]}] (0.5, 1.5) -- (0.5, 2.1);
	\draw[very thick,arrows={|->[scale=1.5]}] (1.5, 1.5) -- (1.5, 0.9);
...
Supported features include: several built-in base theories, support of quantifiers and a model generation ability. The latter is a very important requirement for the project at hand.
...
\begin{scope}[scale=1.5]
	...
	\node[anchor=center, font=\footnotesize] at (0.75, 2.1) {f 1-1};
	\node[anchor=center, font=\footnotesize] at (1.75, 2.1) {f 1-2};
	\node[anchor=center, font=\footnotesize] at (2.75, 2.1) {f 1-3};
	\node[anchor=center, font=\footnotesize] at (0.75, 1.1) {f 2-1};
	\node[anchor=center, font=\footnotesize] at (1.75, 1.1) {f 2-2};
	\node[anchor=center, font=\footnotesize] at (2.75, 1.1) {f 2-3};
	\node[anchor=center, font=\footnotesize] at (0.75, 0.1) {f 3-1};
	\node[anchor=center, font=\footnotesize] at (1.75, 0.1) {f 3-2};
	\node[anchor=center, font=\footnotesize] at (2.75, 0.1) {f 3-3};
...
Now we model the country restriction. In the QF\_LIA encoding we said: `If a field is greater than zero the rest has to be zero.' Which could also be stated as: `If a field is unequal to zero the rest has to be equal to zero."
...
But how to model this additional constraint in SMT? To answer that we will look again at the puzzle in Figure~\ref{fig:solver_example}. But this time we need the solution to this puzzle which is shown in Figure~\ref{fig:solver_example_solution}.
\begin{figure}
  \centering
    \begin{tikzpicture}
...
\begin{scope}
	...
	\draw[very thick,arrows={|->[scale=1.5]}] (0.5, 2.5) -- (0.5, 1.9);
	\draw[very thick,arrows={|->[scale=1.5]}] (0.5, 0.5) -- (2.1, 0.5);
\end{scope}
	\end{tikzpicture}
...
\subsection{Drawing} Clicking `Drawing' leads to a similar menu like in Generator where one can choose the width and height of the puzzle and this is followed by a screen similar to the one in Figure~\ref{fig:drawing_screen}.
...
Trying to generate puzzles greater than 12x12 will take a pretty long time (up to 30 minutes), one might get lucky and produce a puzzle with a unique solution within seconds but a waiting time of several minutes is way more likely.
